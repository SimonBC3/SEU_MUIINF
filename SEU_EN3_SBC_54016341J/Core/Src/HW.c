...
int checkSensorChange()
{
	...
	if (leftButtonLastState != leftButtonCurrentState && leftButtonCurrentState == GPIO_PIN_RESET)
	{
		leftButtonLastState = GPIO_PIN_RESET;
	}

	if (leftButtonLastState != leftButtonCurrentState && leftButtonCurrentState == GPIO_PIN_SET)
	{
